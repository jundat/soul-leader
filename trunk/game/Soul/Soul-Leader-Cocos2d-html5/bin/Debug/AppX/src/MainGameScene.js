...
var MainGame = cc.LayerColor.extend({
    ...
    OnReceiveData: function (data) {
        ...
        //         this.m_Mark = cc.LabelTTF.create("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "Arial", 38);
        //         this.m_Mark.setPosition(cc.p(100, 100));
        //         this.m_Mark.setFontFillColor(new cc.Color3B(255, 0, 0))
        //         this.addChild(this.m_Mark);
